    ...
    <div className="flex flex-col justify-center items-center min-h-screen min-w-full">
      ...
      <div className="flex-1 flex flex-col justify-start items-center w-1/2 mb-4 space-y-4">
        <div className="w-full flex flex-row items-stretch justify-end space-x-2">
          ...
          <button className="cursor-pointer outline-none focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50 bg-blue-500 rounded-lg font-medium text-white text-xs text-center px-4 py-2 transition duration-300 ease-in-out hover:bg-blue-600">
            SAVE
          </button>
        </div>
        <QuestionarieBuilder />
