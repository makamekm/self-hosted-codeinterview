...
export const SOCKET_SERVER = process.env.SELF_URL;
export const URI = process.env.SELF_URL;
export const GOOGLE_AUTH_REDIRRECT = `${process.env.SELF_URL}/api/google/redirect`;
